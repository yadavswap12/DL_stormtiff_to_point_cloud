...
def locsPerTile2(tile_start_pix_y, tile_start_pix_x, tile_size, num_locs_est_tile_lin_fit_file_name, num_locs_est_tile_quad_fit_file_name, locs_est_storm_tile_lin_fit, locs_est_storm_tile_quad_fit):
    ...
    # Initialize localizations per tile in raw image coordinates and tile coordinates. 
