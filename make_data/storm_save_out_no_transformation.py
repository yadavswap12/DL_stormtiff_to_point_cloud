...
storm_exp_name = "647storm_pt01_saturation"
...
if not os.path.exists(storm_exp_directory + "stormtiffs_uint8\\"):
    os.mkdir(storm_exp_directory + "stormtiffs_uint8\\")
    
stormtiffs_directory_uint8 = storm_exp_directory + "stormtiffs_uint8\\"
